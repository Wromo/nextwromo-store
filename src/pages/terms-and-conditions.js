      ...
      <div className="bg-white">
        <div className="max-w-screen-2xl mx-auto lg:py-20 py-10 px-3 sm:px-10">
          ...
          <div className="mb-6 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                We employ the use of cookies. By accessing NextWromo, you
                agreed to use cookies in agreement with the NextWromo's Privacy
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                Unless otherwise stated, NextWromo and/or its licensors own the
                intellectual property rights for all material on NextWromo. All
                intellectual property rights are reserved. You may access this
                from NextWromo for your own personal use subjected to
              ...
              <p>
                ...
                website. NextWromo does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of NextWromo,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, NextWromo shall not be liable for
